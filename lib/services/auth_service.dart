...
import 'package:giftook/pages/0_routes/app_routes.dart';

class AuthService extends GetxController {
  User? currentUser() {
    // 현재 유저(로그인 되지 않은 경우 null 반환)
    // User 라는 클래스는 firebase에서 미리 만들어놓은 클래스
  ...
  void signUp({
    ...
    try {
      ...
      // Firebase auth 에러 발생
      // onError(e.message!);  <- 기본 영문 에러코드
      // 이하는 영문 에러코드를 한글로 번역하여 출력하도록 에러코드 커스텀
